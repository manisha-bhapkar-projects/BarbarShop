...
export default (date = new Date()) => {
  // console.log("hsdkkhdskhjkdshjkdshjkhdshdshkj",date,date = new Date())
  const monthDays = getMonthDays(date);
  const monthFirstDay = getMonthFirstDay(date);
  const [year, month] = getDateArray(date);
  //   console.log(monthDays, monthFirstDay, year, month, date, new Date());
  ...
  //   console.log(prevMonthDates,thisMonthDates,nextMonthDates)
